<?php
    ...
    // Carrega o arquivo de dados das capitais, que contém uma lista (array) com as perguntas e suas respostas.
    // Esse é um arquivo php que retorna dados.
    $database = require __DIR__ . '/data/database.php';
